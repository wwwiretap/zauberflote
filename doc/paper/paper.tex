...
Our next empirical analysis was to keep the ratio of seeders to leechers constant at X, and compare the page load times for a throttled HTTP server vs \zbf as we increase the number of users attempting to concurrently load the page. 

\begin{figure}[h]
% TODO: other plot here
% TODO: figure out ratio of seeders to leechers
\caption{Average page load time over P2P compared to HTTP on throttled server assuming constant ratio of X seeders per leecher}
\end{figure}
